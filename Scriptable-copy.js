...
class Configuration {
    ...
    userName = 'kwang'; // username of administrator of the hb-service
    password = 'd4vNooYv0JsYY!99R!#&1S*#h$NAx%&O'; // password of administrator of the hb-service
    notificationEnabled = true; // set to false to disable all notifications
    command = 'tail -f  ~/priceHistory.txt -n 5';
    firstOutputLine = "kevin@kwangH:~ $ tail -f priceHistory.txt -n 5";
    ...
    title_systemGuiName = 'kwang-pyScript'; // name of the system your service is running on
...
const widgetTitle = ' Realtime CNY ';
const dateFormat = 'yyyy.MM.dd HH:mm:ss'; // for US use 'MM/dd/yyyy HH:mm:ss';
